                ...
                <div class="d-flex">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                      <a class="dropdown-item" href="#">Ordenar Por</a>
                      <a class="dropdown-item" href="#">De la A a la Z</a>
                      <a class="dropdown-item" href="#">De la Z a la A</a>
            ...
            <div class="border p-4 rounded mb-4">
              ...
              <div class="mb-4">
                ...
                <label for="s_sm" class="d-flex">
                  <input type="checkbox" id="s_sm" class="mr-2 mt-1"> <span class="text-black">Pequeña (2,319)</span>
                </label>
                <label for="s_md" class="d-flex">
                  <input type="checkbox" id="s_md" class="mr-2 mt-1"> <span class="text-black">Mediana (1,282)</span>
                </label>
                ...
                <div class="row">
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                    <a class="block-2-item" href="#">
                      ...
                      <div class="text">
                        <span class="text-uppercase">Colecion</span>
                        <h3>Mujer</h3>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                    <a class="block-2-item" href="#">
                      ...
                      <div class="text">
                        <span class="text-uppercase">Coleción</span>
                        <h3>Hombre</h3>
                      </div>
                    </a>
                  </div>
