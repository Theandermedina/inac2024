...
<html lang="en">
  <head>
    <title>Qie esShoppers &mdash; Colorlib e-Commerce Template</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12">
            ...
            ¿Es Cliente? <a href="#">haga clic aquí </a>para iniciar sesión
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6 mb-5 mb-md-0">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <label for="c_postal_zip" class="text-black">Correo <span class="text-danger">*</span></label>
                ...
                <div class="collapse" id="ship_different_address">
                  <div class="py-2">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <label for="c_diff_postal_zip" class="text-black">Correo <span class="text-danger">*</span></label>
